 ...
 * Permite al usuario crear un titular y operar con una Caja de Ahorro y una
 * Cuenta Corriente a través de un menú interactivo.
 *
...
public class Banco {
     ...
     * Gestiona la creación de un titular y la interacción con los menús de
     * Caja de Ahorro y Cuenta Corriente para realizar depósitos y extracciones.
     *
    ...
    public static void main(String args[]) {
        ...
        Calendar fechaTitular = new GregorianCalendar(anioNacimientoTitular, mesNacimientoTitular - 1,
                diaNacimientoTitular);
                    ...
                    do {
                        ...
                        switch (opcionCaja) {
                            ...
                            case 3:
                                ...
                                if(!cajaDeAhorro.extraer(importeExtraccionCA)){
                                    System.out.println(cajaDeAhorro.xQNoPuedeExtraer(importeExtraccionCA));
                                }
                                break;
                            case 0:
                                break;
                    ...
                    do {
                        ...
                        switch (opcionCuenta) {
                            ...
                            case 3:
                                ...
                                if(!cuentaCorriente.extraer(importeExtraccionCC)){
                                     System.out.println(cuentaCorriente.xQNoPuedeExtraer(importeExtraccionCC));
                                }
                                break;
                            case 0:
                                break;
